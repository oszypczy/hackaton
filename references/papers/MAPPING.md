...
- **Authors / venue:** NUS team (Reza Shokri's group); ICLR 2025 conference paper.
...
- **Core idea:** for SSL encoders, density-estimation log-likelihood of encoder outputs on victim's training data is **higher than on independently-trained encoders** → ownership signal even without labeled downstream task.
