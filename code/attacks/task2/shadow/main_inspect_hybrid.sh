#!/usr/bin/env bash
#SBATCH --job-name=t2-shadow-inspect-hybrid
...
#SBATCH --output=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_inspect_hybrid_%j.out
#SBATCH --error=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_inspect_hybrid_%j.out
set -euo pipefail
...
# A+B hybrid inspect on task/ data (has [REDACTED] in output field)
python -u "$ATTACK" --mode inspect --greedy-only --redacted-prefix \
    --task-dir "$DATA_DIR/task"
