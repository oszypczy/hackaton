#!/usr/bin/env bash
#SBATCH --job-name=t2-shadow-val-seed
...
#SBATCH --output=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_val_seed_%j.out
#SBATCH --error=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_val_seed_%j.out
set -euo pipefail
...
python -u "$ATTACK" --mode val --greedy-only --seed-answer
