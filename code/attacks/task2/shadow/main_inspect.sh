#!/usr/bin/env bash
#SBATCH --job-name=t2-shadow-inspect
...
#SBATCH --output=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_inspect_%j.out
#SBATCH --error=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_inspect_%j.out
set -euo pipefail
...
# 5. venv (personal — has all packages)
...
python -u "$ATTACK" --mode inspect --greedy-only
