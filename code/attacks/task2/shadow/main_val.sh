...
#SBATCH --output=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_val_%j.out
#SBATCH --error=/p/project1/training2615/murdzek2/Hackathon/output/attack_shadow_val_%j.out
set -euo pipefail
...
python -u "$ATTACK" --mode val --greedy-only
