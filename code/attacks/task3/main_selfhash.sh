...
#SBATCH --output=/p/scratch/training2615/kempinski1/Czumpers/task3/output/%j_selfhash.out
#SBATCH --error=/p/scratch/training2615/kempinski1/Czumpers/task3/output/%j_selfhash.err
