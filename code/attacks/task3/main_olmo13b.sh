...
# OLMo-2-13B-Instruct PPL features. 13B fp16 = 26GB (fits A800 44GB).
# Pattern: 1B PPL=0.158, 7B PPL=0.259. 13B = ~0.30+?
...
python code/attacks/task3/main.py \
    ...
    --out "$TASK_OUT/submission_olmo13b.csv" \
    --n-rows 2250

echo "Done. Submission at $TASK_OUT/submission_olmo13b.csv"
